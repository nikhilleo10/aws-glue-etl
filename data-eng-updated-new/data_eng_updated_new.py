...
def data_eng():
    ...
    t = transform_to_follow_up_notes(t,getNewFollowUpText)
    ...
    # upsertToRedshift2(renewal_history_dy_frame, 'renewal_history','id')
    # print(f"End Time: {getCurrentTime()}")
    print('Updated to check if notebook is working...')
    job.commit()

# In[ ]:
def transform_to_follow_up_notes(t,getNewFollowUpText):
        ...
        t = t.withColumn('notes_type',notesTypeFollowUp())
        return t
