if [ ! -f "./data-eng-updated/data-eng-updated.json" ]; then
echo Error: data-eng-updated.json File does not exist
exit 1
fi
...
cd_properties_file='./data-eng-updated/data-eng-updated.json'
